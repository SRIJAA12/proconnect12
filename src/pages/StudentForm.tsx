      ...
      case 3: // Professional Contacts
        if (hasRelativesInIT) {
          for (let i = 0; i < relativesInIT.length; i++) {
            if (!relativesInIT[i].name || !relativesInIT[i].relationship || !relativesInIT[i].whatsappNumber || !relativesInIT[i].education || !relativesInIT[i].occupationType || !relativesInIT[i].email) {
